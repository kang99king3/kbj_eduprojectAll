...
<body>
<h1>나의정보수정</h1>
<form action="LoginController.do" method="post" enctype="application/x-www-form-urlencoded">
	...
	<tr>
		<td colspan="2">
			...
			<input type="button" value="나의정보"
			 onclick="location.href='LoginController.do?command=userinfo&id=${dto.id}'"/>
		</td>
	</tr>
</table>
</form>
