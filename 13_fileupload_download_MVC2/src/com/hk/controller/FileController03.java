...
@WebServlet("/FileController03.do")
public class FileController03 extends HttpServlet {
		...
		if(command==null||command.equals("")) { //업로드 요청(multipart로 요청)
			...
			try {
				...
				while(files.hasMoreElements()) {
					...
					//4.DB에 정보 저장하기
					 isS=dao.insertFileInfo(new FileDto(0, origin_fname, stored_fname, file_size, null, null));
